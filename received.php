...
$userList = array_merge(
    get_users_by_capability(get_context_instance(CONTEXT_SYSTEM), 'block/moodletxt:receivemessages'),
    get_users_by_capability(get_context_instance(CONTEXT_COURSE, $courseId), 'block/moodletxt:receivemessages')
);
$userArray = array(0 => '');
...
if (! $table->is_downloading()) {
    ...
    echo(html_writer::tag('div', null, array('class' => 'cleared')));
